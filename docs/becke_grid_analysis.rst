...
quadrature using the Becke grid :cite:p:`becke:1988:multicenter`. The radial
Gauss-Chebychev points describe the distance from an atomic center, while the
Lebedev points :cite:p:`lebedev:1976` describe directions on the unit sphere.
Their tensor product gives an atom-centered grid.
...
.. figure:: _static/img/user_interface/06-becke-grid.png
   :width: 82%
...
.. figure:: _static/img/user_interface/06-grid-points.png
   :width: 82%
